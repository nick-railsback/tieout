...
> **Covers:** Privacy apps with Noir ZK circuits — the bb toolchain, the commitment-nullifier-Merkle pattern, and Solidity verifiers.  
> **When to read:** Building a Noir-based / zero-knowledge privacy app on the EVM.  
