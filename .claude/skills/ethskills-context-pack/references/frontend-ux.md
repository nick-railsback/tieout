...
> **Covers:** Frontend UX patterns for dApps — per-button loaders, the three-button flow, Address components, USD values.  
> **When to read:** Building the UI for a dApp.  
...
**Related references:** [orchestration](orchestration.md) · [frontend-playbook](frontend-playbook.md) · [tools](tools.md)  
