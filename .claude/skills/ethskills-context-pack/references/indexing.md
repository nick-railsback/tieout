...
> **Covers:** Reading onchain data — events, The Graph, Dune, and Multicall3.  
> **When to read:** Querying historical or onchain data, or designing contracts event-first.  
...
**Related references:** [tools](tools.md) · [concepts](concepts.md)  
