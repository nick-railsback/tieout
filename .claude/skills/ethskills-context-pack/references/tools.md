...
> **Covers:** Dev tooling — Foundry, Scaffold-ETH 2, Blockscout MCP, x402 SDKs, abi.ninja.  
> **When to read:** Picking development tooling or wiring up AI-agent infrastructure.  
...
**Related references:** [testing](testing.md) · [orchestration](orchestration.md) · [indexing](indexing.md) · [addresses](addresses.md)  
