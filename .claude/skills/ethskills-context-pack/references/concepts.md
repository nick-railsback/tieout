...
> **Covers:** Essential mental models — nothing runs itself; every state transition needs a caller and an incentive.  
> **When to read:** Designing contract logic, state transitions, and incentives.  
...
**Related references:** [ship](ship.md) · [indexing](indexing.md) · [security](security.md)  
