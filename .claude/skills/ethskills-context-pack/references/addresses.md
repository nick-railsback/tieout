...
> **Covers:** Verified contract addresses for major protocols across mainnet and L2s (verified onchain, March 2026).  
> **When to read:** You need a real protocol address — never hallucinate one; a wrong address means lost funds.  
...
**Related references:** [building-blocks](building-blocks.md) · [l2s](l2s.md) · [security](security.md)  
