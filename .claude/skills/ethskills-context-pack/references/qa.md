...
> **Covers:** A pre-ship audit checklist for a separate reviewer agent — covers only the bugs AI agents actually ship.  
> **When to read:** After a build is complete — hand this to a fresh reviewer agent.  
...
1. Read the source code (`app/`, `components/`, [addresses.md](addresses.md))
...
**Related references:** [frontend-ux](frontend-ux.md) · [orchestration](orchestration.md) · [security](security.md)  
