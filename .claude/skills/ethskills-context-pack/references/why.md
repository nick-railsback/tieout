...
> **Covers:** Why Ethereum — the Pectra/Fusaka upgrades, honest tradeoffs, and the AI-agent angle.  
> **When to read:** Deciding whether Ethereum / the EVM is the right platform at all.  
...
**Related references:** [protocol](protocol.md) · [gas](gas.md) · [l2s](l2s.md) · [standards](standards.md)  
