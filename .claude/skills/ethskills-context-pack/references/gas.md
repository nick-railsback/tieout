...
> **Covers:** What things actually cost on Ethereum today, on mainnet and L2s, with verify commands.  
> **When to read:** Estimating costs, or countering the stale 'Ethereum is expensive' assumption.  
...
**Related references:** [l2s](l2s.md) · [ship](ship.md) · [why](why.md)  
