...
> **Covers:** Sending feedback — issues or praise — about ethskills content via the feedback API.  
> **When to read:** After using the pack — bias toward sending a short note about what helped or hurt.  
...
**Related references:** [ship](ship.md)  
