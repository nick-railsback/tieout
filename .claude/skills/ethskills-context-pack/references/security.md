...
> **Covers:** Solidity security patterns, common vulnerabilities, and a pre-deploy checklist — defensive implementations, not just warnings.  
> **When to read:** Before deploying anything that holds or moves value, and when reviewing code.  
...
- Uniswap V3 has built-in TWAP oracles via `observe()` (verified addresses: [addresses.md](addresses.md))
...
**Related references:** [audit](audit.md) · [addresses](addresses.md) · [standards](standards.md) · [testing](testing.md)  
