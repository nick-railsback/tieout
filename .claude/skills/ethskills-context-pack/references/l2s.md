...
> **Covers:** The L2 landscape, bridging, deployment differences, and each chain's unique superpower.  
> **When to read:** Choosing a chain or deploying to a Layer 2.  
...
> Mainnet costs at ~0.1 gwei base fee, ~$2,000 ETH. L2 costs are approximate. All fluctuate — see [gas.md](gas.md) for methodology.
...
> **Before choosing an L2:** Mainnet is ~$0.004/transfer, ~$0.04/swap at current gas — cheap enough for most apps. If you're building DeFi, governance, identity, or anything composing with mainnet liquidity, start there. See [ship.md](ship.md) and [gas.md](gas.md) for the full chain selection framework.
...
See [addresses.md](addresses.md) for verified contract addresses for all these protocols.
...
**Related references:** [gas](gas.md) · [addresses](addresses.md) · [building-blocks](building-blocks.md) · [ship](ship.md)  
