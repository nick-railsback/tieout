...
> **Covers:** The three-phase build system for Scaffold-ETH 2 dApps (localhost → live contracts → production).  
> **When to read:** Driving a Scaffold-ETH 2 build end to end.  
...
5. Audit contracts before moving to frontend — fetch [audit.md](audit.md) and run through it
...
See [wallets.md](wallets.md) for full key safety guide, what to do if you've already leaked a key, and safe patterns for deployment.
...
- Run a full frontend QA audit — fetch [qa.md](qa.md) and give it to a separate agent before deploying
...
**Related references:** [audit](audit.md) · [qa](qa.md) · [frontend-ux](frontend-ux.md) · [frontend-playbook](frontend-playbook.md) · [tools](tools.md)  
