...
> **Covers:** DeFi composability — Uniswap, Aave, flash loans, and Uniswap V4 hooks.  
> **When to read:** Integrating with or composing on top of existing DeFi protocols.  
...
See [addresses.md](addresses.md) for complete multi-chain address list including L2-native protocols (Aerodrome, GMX, Pendle, Velodrome, Camelot, SyncSwap, Morpho).
...
See [addresses.md](addresses.md) for all verified protocol addresses (GMX, Pendle, Camelot, Aerodrome, Velodrome, SyncSwap, Morpho).
...
**Related references:** [addresses](addresses.md) · [security](security.md) · [standards](standards.md)  
