...
> **Covers:** Foundry testing — unit, fuzz, fork, and invariant tests.  
> **When to read:** Testing contracts before deploy.  
...
**You don't fork-test.** If your contract calls Uniswap, Aave, or any external protocol (verified addresses: [addresses.md](addresses.md)), test against their real deployed contracts on a fork. Mocking them hides integration bugs that only appear with real state.
...
**Related references:** [addresses](addresses.md) · [security](security.md) · [building-blocks](building-blocks.md)  
