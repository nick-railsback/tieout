...
> **Covers:** How Ethereum evolves — EIP lifecycle, the fork process, and tracking upcoming changes (Glamsterdam).  
> **When to read:** Reasoning about what has actually shipped vs. what is aspirational, or about upcoming forks.  
...
**Related references:** [why](why.md) · [standards](standards.md)  
