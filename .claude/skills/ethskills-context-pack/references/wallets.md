...
> **Covers:** Creating wallets, key safety, multisig, account abstraction, and EIP-7702.  
> **When to read:** Handling keys, signing, production treasuries, or smart-account features.  
...
**Related references:** [security](security.md) · [standards](standards.md) · [frontend-playbook](frontend-playbook.md)  
